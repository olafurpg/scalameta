...
final case class UniversalType(
    ...
    ) extends scala.meta.internal.semanticdb3.semanticdb3.Type with scalapb.GeneratedMessage with scalapb.Message[UniversalType] with scalapb.lenses.Updatable[UniversalType] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): scala.meta.internal.semanticdb3.semanticdb3.UniversalType = {
    ...
    def withTypeParameters(__v: scala.meta.internal.semanticdb3.semanticdb3.Scope): UniversalType = copy(typeParameters = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => tpe.asTypeMessage.toPMessage
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion = scala.meta.internal.semanticdb3.semanticdb3.UniversalType
}

object UniversalType extends scalapb.GeneratedMessageCompanion[scala.meta.internal.semanticdb3.semanticdb3.UniversalType] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[scala.meta.internal.semanticdb3.semanticdb3.UniversalType] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scala.meta.internal.semanticdb3.semanticdb3.UniversalType = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[scala.meta.internal.semanticdb3.semanticdb3.UniversalType] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = scala.meta.internal.semanticdb3.semanticdb3.UniversalType(
  )
  implicit class UniversalTypeLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, scala.meta.internal.semanticdb3.semanticdb3.UniversalType]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, scala.meta.internal.semanticdb3.semanticdb3.UniversalType](_l) {
