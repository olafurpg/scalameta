...
final case class Range(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): scala.meta.internal.semanticdb3.semanticdb3.Range = {
    ...
    def companion = scala.meta.internal.semanticdb3.semanticdb3.Range
}

object Range extends scalapb.GeneratedMessageCompanion[scala.meta.internal.semanticdb3.semanticdb3.Range] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[scala.meta.internal.semanticdb3.semanticdb3.Range] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scala.meta.internal.semanticdb3.semanticdb3.Range = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[scala.meta.internal.semanticdb3.semanticdb3.Range] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = scala.meta.internal.semanticdb3.semanticdb3.Range(
  )
  implicit class RangeLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, scala.meta.internal.semanticdb3.semanticdb3.Range]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, scala.meta.internal.semanticdb3.semanticdb3.Range](_l) {
